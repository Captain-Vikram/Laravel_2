...
<div class="container">
    ...
    <div class="card">
        <form method="POST" action="{{ route('urls.store') }}" id="url-form">
            @csrf
        ...
        <div id="short-url-container" class="result">
            ...
            <div class="url-display">
                <a href="{{ url('/'.session('shortCode')) }}" id="short-url" target="_blank">{{ url('/'.session('shortCode')) }}</a>
                <button id="copy-btn" class="btn-copy" data-clipboard-text="{{ url('/'.session('shortCode')) }}">
            ...
            <div class="qr-container">
                ...
                <div id="qr-code" data-url="{{ url('/'.session('shortCode')) }}"></div>
            </div>
        </div>
        @endif
    </div>
            ...
            <table>
                ...
                <tbody id="urlTable">
                    ...
                    <tr>
                        ...
                        <td class="original-url">{{ Str::limit($url->original_url, 50) }}</td>
                        <td>{{ $url->clicks }}</td>
                        <td>{{ $url->created_at->format('M d, Y') }}</td>
                        <td>
                            <a href="{{ route('urls.stats', $url->short_code) }}" class="btn-action" title="View Stats">
                                <i class="fas fa-chart-pie"></i>
                            </a>
                            <form method="POST" action="{{ route('urls.destroy', $url->short_code) }}" style="display:inline">
                                @csrf
                                @method('DELETE')
